...
namespace HiarcSDKIntegrationTest.Tests
{
    public class FileTests : HiarcTestBase
    {
        ...
        public async void FileCRUD()
        {
            ...
            Assert.Equal(f1, fetchedFile, new SdkEntityComparer());

            var newName = "New Name.txt";
            var newDescription = "New description";
            var updateRequest = new HiarcSDK.Model.UpdateFileRequest { Name=newName, Description=newDescription };
            ...
            updateRequest = new HiarcSDK.Model.UpdateFileRequest { Key="new key", Name=newName, Description=newDescription };
        ...
        public async void FileVersionsCreatedBy()
        {
            ...
            await _hiarc.AddUserToFile(u1.Key, f1.Key, HiarcSDK.Model.AccessLevel.READ_WRITE);
        ...
        public async void FileVersionsRespectAccessLevel()
        {
            ...
            var u1 = await _hiarc.CreateUser();
            await _hiarc.AddUserToFile(u1.Key, f1.Key, HiarcSDK.Model.AccessLevel.READ_ONLY);
            ...
            await _hiarc.AddUserToFile(u2.Key, f1.Key, HiarcSDK.Model.AccessLevel.UPLOAD_ONLY);
            ...
            await _hiarc.AddUserToFile(u3.Key, f1.Key, HiarcSDK.Model.AccessLevel.READ_WRITE);
            ...
            await _hiarc.AddUserToFile(u4.Key, f1.Key, HiarcSDK.Model.AccessLevel.CO_OWNER);
        ...
        public async void GetAllowedFiles()
        {
            ...
            await _hiarc.AddUserToCollection(c1.Key, u1.Key, accessLevel: HiarcSDK.Model.AccessLevel.READ_ONLY);
            ...
            await _hiarc.AddUserToCollection(c2.Key, u1.Key, accessLevel: HiarcSDK.Model.AccessLevel.READ_ONLY);
        ...
        public async void DirectDownloadUrl()
        {
            ...
            Assert.True(directDownloadUrl.ExpiresAt < now.AddSeconds(DEFAULT_EXPIRES_IN_SECONDS));
        ...
        public async void UserCanAccessFileOtherGroupRoot()
        {
            ...
            await _hiarc.AddGroupToCollection(c1.Key,g1.Key, HiarcSDK.Model.AccessLevel.READ_ONLY);
        ...
        public async void CreateFileWithMetadata()
        {
            ...
            Assert.Equal(f1, fetchedFile, new SdkEntityComparer());
            AssertMetadataSdk(md, fetchedFile.Metadata);
        ...
        public async void UpdateMetadata()
        {
            ...
            var request = new HiarcSDK.Model.UpdateFileRequest
            {
                Metadata = updatedMD
            };

            var updatedFile = await _hiarc.UpdateFile(f1.Key, request);
            AssertMetadataSdk(updatedMD, updatedFile.Metadata);
        ...
        public async void NullOutMetadata()
        {
            ...
            request = new HiarcSDK.Model.UpdateFileRequest
            {
                Metadata = updatedMD
            };

...
namespace HiarcSDK.Test
{
    ...
    public class UpdateGroupRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" UpdateGroupRequest
            //Assert.IsInstanceOfType<UpdateGroupRequest> (instance, "variable 'instance' is a UpdateGroupRequest");
        }

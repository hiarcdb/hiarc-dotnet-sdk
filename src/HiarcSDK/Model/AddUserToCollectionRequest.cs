...
namespace HiarcSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddUserToCollectionRequest :  IEquatable<AddUserToCollectionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddUserToCollectionRequest" /> class.
        /// </summary>
        /// <param name="userKey">userKey.</param>
        /// <param name="accessLevel">accessLevel.</param>
        public AddUserToCollectionRequest(string userKey = default(string), AccessLevel? accessLevel = default(AccessLevel?))
        {
        ...
        {
            return this.Equals(input as AddUserToCollectionRequest);
        }

        /// <summary>
        /// Returns true if AddUserToCollectionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddUserToCollectionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddUserToCollectionRequest input)
        {
            if (input == null)
                return false;

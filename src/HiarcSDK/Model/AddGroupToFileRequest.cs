...
namespace HiarcSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddGroupToFileRequest :  IEquatable<AddGroupToFileRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddGroupToFileRequest" /> class.
        /// </summary>
        /// <param name="groupKey">groupKey.</param>
        /// <param name="accessLevel">accessLevel.</param>
        public AddGroupToFileRequest(string groupKey = default(string), AccessLevel? accessLevel = default(AccessLevel?))
        {
        ...
        {
            return this.Equals(input as AddGroupToFileRequest);
        }

        /// <summary>
        /// Returns true if AddGroupToFileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddGroupToFileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddGroupToFileRequest input)
        {
            if (input == null)
                return false;

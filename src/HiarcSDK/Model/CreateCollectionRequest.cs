...
namespace HiarcSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCollectionRequest : CreateOrUpdateEntityRequest,  IEquatable<CreateCollectionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateCollectionRequest(string key = default(string), string name = default(string), string description = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>)) : base(key, name, description, metadata)
        {
        }

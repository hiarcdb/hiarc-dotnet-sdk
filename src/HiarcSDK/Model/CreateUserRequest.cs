...
namespace HiarcSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateUserRequest : CreateOrUpdateEntityRequest,  IEquatable<CreateUserRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateUserRequest(string key = default(string), string name = default(string), string description = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>)) : base(key, name, description, metadata)
        {
        }

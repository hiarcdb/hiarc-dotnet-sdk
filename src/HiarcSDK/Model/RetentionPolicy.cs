...
namespace HiarcSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RetentionPolicy : Entity,  IEquatable<RetentionPolicy>, IValidatableObject
    {
        /// <summary>
        ...
        public RetentionPolicy(uint seconds = default(int), string key = default(string), string type = default(string), string name = default(string), string description = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), string createdBy = default(string), DateTime createdAt = default(DateTime), DateTime modifiedAt = default(DateTime)) : base(key, type, name, description, metadata, createdBy, createdAt, modifiedAt)
        {

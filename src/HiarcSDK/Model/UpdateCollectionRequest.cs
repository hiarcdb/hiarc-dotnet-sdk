...
namespace HiarcSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateCollectionRequest : CreateOrUpdateEntityRequest,  IEquatable<UpdateCollectionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateCollectionRequest(string key = default(string), string name = default(string), string description = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>)) : base(key, name, description, metadata)
        {
        }
